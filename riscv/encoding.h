 ...
 * https://github.com/riscv/riscv-opcodes (a37bbd3)
 */
...
#define CSR_SSPMPSWITCH    0X110
#define CSR_SSPMPSWITCHH   0X111
...
DECLARE_CSR(sspmpswitch, CSR_SSPMPSWITCH)
DECLARE_CSR(sspmpswitchh, CSR_SSPMPSWITCHH)
#endif
#ifdef DECLARE_CAUSE
